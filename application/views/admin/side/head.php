<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>master/favicon.png">
    <title>SDABA02</title>
    <!-- Bootstrap Core CSS -->
    ...
    <link href="<?php echo base_url() ?>master/adm/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <!--This page css - Morris CSS -->
    <link href="<?php echo base_url() ?>master/adm/assets/plugins/c3-master/c3.min.css" rel="stylesheet">
    <!-- Custom CSS -->
