            ...
            <h4 class="m-b-20">Denah Sekolah</h4>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <div class="col-lg-12">  
                                <a style="float: right; margin-bottom: 30px; " href="" class="btn btn-success" data-toggle="modal" data-target="#edit_denah"> Edit</a>
                                <div id="edit_denah" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Edit Gambar Denah (+)</h4> 
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <from class="form-horizontal form-material">
