    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor">Waka Kurikulum</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url("admin/Dashboard") ?>">Home</a></li>
                    <li class="breadcrumb-item active">Waka Kurikulum</li>
                </ol>
            </div>
        	...
        	<div class="col-lg-12 col-xlg-9 col-md-7">
	            <div class="card">
	                ...
	                <div class="tab-content">
                        ...
                        <?php foreach ($viewKurikulum->result() as $vk) { ?>
                          <div class="card-body">
                        ...
                        <?php foreach ($viewStruktur->result() as $vs) { ?>
                          <div class="card-body">
	                           <img class="img-responsive" src="<?php echo base_url().$vs->gambar_struktur; ?>" alt="Gambar Struktur Kurikulum">
	                        </div>
                        <?php } ?>
          ...
          <div class="col-lg-8 col-xlg-9 col-md-7">
  	            <div class="card">
  		                ...
  		                <div class="tab-content">
                            ...
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/StrukturPers/editKurikulum'); ?>">
  		                        <div class="card-body">
                                <?php foreach ($viewKurikulum->result() as $k) { ?>
                                  <input type="text" name="id_bidangKurikulum" value="<?php echo $k->id_bidang; ?>" hidden>
                                <?php } ?>
  		                           <textarea class="summernote" name="isi_proker_kurikulum">
                            ...
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/StrukturPers/editStrukturKurikulum'); ?>">
  		                        <div class="card-body">
  		                           	<h4 class="card-title">Upload Gambar Galery (+)</h4>
  	                                <small>Maksimal ukuran upload 5 Mb.</small>
                                    <?php foreach ($viewStruktur->result() as $vs) { ?>
  	                                <input type="file" id="input-file-now" class="dropify" name="gambar_struktur_kurikulum" data-default-file="<?php echo base_url().$vs->gambar_struktur; ?>" /><?php } ?>
  	                             </div>
                                 <div class="card-body">
           	                    	<button class="btn btn-success" style="float: right;">Simpan</button>
           	                    </div>
