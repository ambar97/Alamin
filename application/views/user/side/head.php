<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url() ?>master/client/img/favicon.png" type="image/x-icon" />
    <link rel="apple-touch-icon" href="<?php echo base_url() ?>master/client/img/apple-touch-icon.png">
    ...
    <!-- Current Page CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>master/client/vendor/rs-plugin/css/settings.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>master/client/vendor/rs-plugin/css/layers.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>master/client/vendor/rs-plugin/css/navigation.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>master/client/vendor/circle-flip-slideshow/css/component.css">
