		...
		<div class="row">
			<div class="col">
				<ul class="breadcrumb">
					...
					<li class="active">Waka Kesiswaan</li>
				</ul>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<h1>Waka Kesiswaan Sekolah</h1>
			</div>
		</div>
	</div>
</section>
			...
			<div class="row">
				<div class="col-12 col-sm-6 col-lg-8 product">
					<span class="product-thumb-info">
							<span>
								<img alt="" class="img-fluid" src="<?php echo base_url(); ?><?php foreach ($struktur_wakakes->result() as $sw) {
									echo $sw->gambar_struktur;
								} ?>">
							</span>
						</a>
						<span class="product-thumb-info-content">
								<h4>Struktur Waka Kesiswaan</h4>
						</span>
					</span>
					<br>
