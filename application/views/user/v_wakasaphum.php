			...
			<div class="row">
				<div class="col-12 col-sm-6 col-lg-8 product">
					<span class="product-thumb-info">
							<span>
								<img alt="" class="img-fluid" src="<?php echo base_url(); ?><?php foreach ($struktur_wakasap->result() as $wsap) {
									echo $wsap->gambar_struktur;
								} ?>">
							</span>
						</a>
						<span class="product-thumb-info-content">
								<h4>Struktur Waka Sapras dan Humas</h4>
						</span>
					</span>
					<br>
