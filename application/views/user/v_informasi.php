						...
						<div class="row">
							...
							<div class="col-lg-7">
								<div class="post-content">
									<h2><a href=""><?php echo $berita->judul_informasi; ?></a></h2>
									<p><?php echo substr($berita-> isi_informasi,0,45); ?></p>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<div class="post-meta">
									<span><i class="fas fa-calendar-alt"></i> <?php echo $berita->date; ?> </span>
